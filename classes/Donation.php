...
class Donation extends ModelLite
{
    ...
    public $tinyIntDescriptions=[
        ...
        "TransactionType"=>["0"=>"Tax Deductible","1"=>"Not Tax Deductible (Donor Advised fund, etc)","3"=>"IRA Qualified Charitable Distribution (QCD)","100"=>"Service (Not Tax Deductible)","101"=>"Product Sale (Not Tax Deductible)","-1"=>"Expense"]
    ];
